WITH t AS
(SELECT MES.[Stream],DS.[Deployment], D.[Name], MES.[Value], MES.[Measurement Time Stamp], MES.[L1 Flag], ROW_NUMBER() OVER (ORDER BY MES.[Measurement Time Stamp]) AS 'RowNumber'
